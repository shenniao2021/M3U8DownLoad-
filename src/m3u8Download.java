...
public class m3u8Download {
    ...
    public void strat() {
        ...
        JButton zhuanmaBtn = new JButton("转码");
        zhuanmaBtn.setBounds(100,200,100,20);
        zhuanmaBtn.setFont(new Font("微软雅黑", Font.BOLD,13));
        zhuanmaBtn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                zhuanma = !zhuanma;
                if (zhuanma){
                ...
                try{
                    while (temp > 0){
                        ...
                        if(httpUrlConnection.getResponseCode() == 200){
                            ...
                            temp--;
                            setMessage("找寻M3U8链接建立失败 状态码为" + httpUrlConnection.getResponseCode() + "重试" + temp);
                        }
                    }
            ...
            try{
                while (temp > 0){
                    ...
                    if(httpUrlConnection.getResponseCode() == 200){
                        ...
                        temp--;
                        setMessage("m3u8链接建立失败 状态码为" + httpUrlConnection.getResponseCode() + "重试" + temp);
                    }
                }
            ...
            try{
                while (temp > 0){
                    ...
                    if(httpUrlConnection.getResponseCode() == 200){
                        ...
                        temp--;
                        setMessage("key建立失败 状态码为" + httpUrlConnection.getResponseCode() + "重试" + temp);
                    }
                }
            }catch (IOException io){
                setMessage(io.getMessage());
